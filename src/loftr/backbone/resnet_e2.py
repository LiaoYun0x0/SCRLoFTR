...
class E2_ResNetFPN_8_2(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        # These should also ideally be divisible by nbr_rotations.理想情况下，这些也应该可以被 nbr_rotations 整除
        ...
        # dummy variable used to track input types to each block用于跟踪每个块的输入类型的虚拟变量
