...
def parse_args():
    ...
    parser.add_argument(
        '--ckpt_path', type=str, default="/third_disk/ML/SELoFTR/se2loftr/logs/tb_logs/default_exp_name/version_3/checkpoints/epoch=3-auc@5=0.470-auc@10=0.633-auc@20=0.763.ckpt", help='path to the checkpoint')
    parser.add_argument(
